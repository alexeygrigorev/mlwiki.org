...
- this is a vector space, but "vectors" are functions: they have [inner product](Dot_Product) with $\int$ instead of $\sum$, and they also have [orthogonality](Orthogonality)
