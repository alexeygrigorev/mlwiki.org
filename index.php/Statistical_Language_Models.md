...
A statistical language model (Language Model for short) is a [probability](Probability) [distribution](Distributions) over sequences of words (i.e. over sentences)
...
- a word sequence is generated by [sampling](Sampling) each word independently 
...
- adjusting MLE to avoid 0 probability is called "smoothing" - it's a form of [regularization](Regularization)
