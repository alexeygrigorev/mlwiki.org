...
- sometimes it's an integral part of the training process (e.g. in [Decision Tree (Data Mining)](Decision_Tree_%28Data_Mining%29) for pruning) (see [Cross Validation](Cross_Validation))
