...
## Examples
### Example 1
10 independent trials are conducted, in each of which the probability of the event occurring is 0.6. Find the variance of the R.V. $X$ -- the number of times the event occurs in these trials.
- $n = 10, p = 0.6, q = 1 - 0.6 = 0.4 $
- $\text{Var}[X] = npq = 10 \cdot 0.6 \cdot 0.4 = 2.4$


### Example 2
A coin is tossed twice. Write the distribution table for the random variable $X$ -- the number of times heads appears.

$p = 0.5, q = 0.5$

Possible values: $x_0 = 0, x_1 = 1, x_2 = 2$
