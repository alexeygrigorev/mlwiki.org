...
To determine the probability of $k$ occurrences of the event in these trials, one uses the Bernoulli formula. If $p$ is large, one can use the Laplace asymptotic formula. However, that formula is also inapplicable when $p \leqslant 0.1$.
