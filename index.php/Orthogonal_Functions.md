...
Two functions $f$ and $g$ are orthogonal if their [inner product](Dot_Product) is 0
...
- this is a [vector space](Vector_Spaces), but "vectors" are functions: they have inner product with $\int$ instead of $\sum$, and they also have [orthogonality](Orthogonality)
