...
---
## CAP Theorem
*CAP* stands for [*C*onsistency](Consistency_%28databases%29), *A*vailability and *P*artition tolerance

### [Consistency](Consistency_%28databases%29)
...
## [Consistency](Consistency_%28databases%29) and Partition tolerance
- But no availability
...
## See also
- [Consistency (databases)](Consistency_%28databases%29)
- [BASE](BASE)
