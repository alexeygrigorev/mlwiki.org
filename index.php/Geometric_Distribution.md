...
Assume we run a series of Bernoulli Trials where the [probability](Probability) of seing the event $A$ is $p$, and, therefore, the probability of not seing $A$ is $q = 1 - p$
