...
- $\iff M_0 \to^* M$
- i.e. there exists a firing sequence that brings us from the initial state of a [petri net](Petri_Net) to a state that corresponds to $M_0$
...
- the [graph](Graph) above is the reachability graph with different notation
