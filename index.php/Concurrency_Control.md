...
- [Multi-Version Concurrency Control](Multi-Version_Concurrency_Control) (MVCC) ([CouchDB](http://en.wikipedia.org/wiki/Multiversion_concurrency_control), [CouchDB](CouchDB)) (also "optimistic concurrency model")
