...
If namenode doesn't start in local mode, do [link](http://stackoverflow.com/questions/8076439/namenode-not-getting-started): 
...
Troubleshooting:
- if datanode doesn't start [link](http://stackoverflow.com/questions/16725804/)
- if yarn resourcemanager doesn't start 
  - "Queue configuration missing child queue names for root" [link](http://stackoverflow.com/questions/28357130/unable-to-start-resourcemanager-capacity-scheduler-xml-not-found-hadoop-2-6-0)
