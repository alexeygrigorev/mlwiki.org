...
- Deerwester, Scott C., et al. "Indexing by [latent semantic analysis](Latent_Semantic_Analysis)." 1990. [[Latent Semantic Analysis](http://www.cob.unt.edu/itds/faculty/evangelopoulos/dsci5910/LSA_Deerwester1990.pdf])(Latent_Semantic_Analysis)
- Domingos, Pedro. "A few useful things to know about [machine learning](Machine_Learning)." 2012. [[Overfitting](http://homes.cs.washington.edu/~pedrod/papers/cacm12.pdf])(Overfitting)

### E
- Elsayed, Tamer, Jimmy Lin, and Douglas W. Oard. "Pairwise document similarity in large collections with [MapReduce](MapReduce)." 2008. [[Inverted Index](http://www.ece.umd.edu/~oard/pdf/acl08elsayed2.pdf])(Inverted_Index)
...
### K
- Kalman, Dan. "A singularly valuable decomposition: the SVD of a [matrix](Matrix)." 1996. [[SVD](http://www.math.washington.edu/~morrow/498_13/svd.pdf])(SVD)
...
### P
- Pagael, Rober, and Moritz Schubotz. "Mathematical Language Processing Project." 2014. [[Mathematical Definition Extraction](http://arxiv.org/abs/1407.0167])(Mathematical_Definition_Extraction) Math-Aware POS Tagging
...
### R
### S
- Salton, et al. "A [vector space model](Vector_Space_Models) for automatic indexing." 1975. [[Vector Space Model](http://cgis.cs.umd.edu/class/fall2009/cmsc828r/PAPERS/VSM_salton-2.pdf])(Vector_Space_Model)
...
- Schelter, Sebastian, et al. "Efficient Sample Generation for Scalable [Meta Learning](Meta_Learning)." [2014. [Meta Learning](http://ssc.io/wp-content/uploads/2014/11/ICDE15_research_150.pdf].)(Meta_Learning)
...
- Slaney, Malcolm, and Michael Casey. "Locality-sensitive hashing for finding nearest neighbors [lecture notes]." 2008. [[Locality Sensitive Hashing](http://web.iitd.ac.in/~sumeet/Slaney2008-LSHTutorial.pdf])(Locality_Sensitive_Hashing), Euclidean LSH
...
### V
### W
- Wilbur, W. John, "The automatic identification of stop words." 1992. [[Stop Words](http://www.researchgate.net/publication/247786801_The_automatic_identification_of_stop_words])(Stop_Words), Term Strength

### X
- Xu, Wei, Xin Liu, and Yihong Gong. "Document clustering based on non-negative matrix factorization." 2003. [[Cluster Analysis](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.117.2293&rep=rep1&type=pdf])(Cluster_Analysis), Non-Negative Matrix Factorization
